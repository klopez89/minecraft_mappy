...
function addTerrainColors(b) {
    ...
    */
    ...
    b.color("map.leaves.cherry", 330, 85, 75);
    ...
    b.color("map.flower.pink", 330, 85, 85);
    ...
    b.color("map.wood.cherry", 6, 50, 80);
...
function addDefaultStyles(b) {
    ...
    if (b.s[SETTING.useLandElevationGradient]) {
        ...
        //    b.style("#ground #redsand, sand[sand_type:red]").colorByElevation("land.redsand").lightnessByElevation("land.lightness.elevation");
        //} else {
        ...
        //TODO blockstate tags
        if (b.isBedrock) {
            b.style("#ground #redsand, sand[sand_type:red]").color("map.redsand").lightnessByElevation("land.lightness.elevation");
        } else {
    ...
    if (b.isBedrock) {
        ...
        //b.style("minecraft:leaves[???_leaf_type:cherry]").color("map.leaves.cherry").useBiomeFoliageColor(false);
    } else {
        ...
        b.style("minecraft:cherry_leaves").color("map.leaves.cherry").useBiomeFoliageColor(false);
    }
...
function addFlowerStyles(b) {
    ...
    b.style("#flower.pink").color("map.flower.pink");
...
function addWoodStyles(b) {
    ...
    b.style("#cherry #artificial").color("map.wood.cherry");
}